...
namespace AmberBim
{
    ...
    public class RebarSolidInView : IExternalCommand
    {
        Application _app;
        Document _doc;
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            {
                TaskDialog.Show("AmberBIM", "Rebar can be set as a Solid only in 3D views!");
            ...
            {
                rebElem.SetSolidInView(activeView3D, true);
            }
